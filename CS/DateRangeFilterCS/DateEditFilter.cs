        ...
        GridColumn FilterColumn {
            get {
                ...
                if (filterPresenter != null) {
                    PropertyInfo pi = filterPresenter.ColumnFilterInfo.GetType().GetProperty("Column", BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic);
                    GridColumn column = pi.GetValue(filterPresenter.ColumnFilterInfo, null) as GridColumn;
                    return column;
                }
                return null;
            }
